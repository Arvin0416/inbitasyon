...
import { createTemplate } from "@/lib/supabase-service";
import type { Template, TemplateMetaVarDefinition } from "@/lib/types";
import { generateSlug } from "@/lib/utils";
import { ArrowLeft, Plus, Trash2, GripVertical, Code2, Eye, FileText } from "lucide-react";
...
<head>
  ...
  <title>{{coupleName1}} & {{coupleName2}} — Wedding Invitation</title>
  <style>
...
<body>
  <div class="container">
    <div class="names">{{coupleName1}} & {{coupleName2}}</div>
    <p style="color:#7A7A7A;margin-bottom:32px;">Together with their families, request the honor of your presence</p>

    <div class="details">
      <div class="detail-row">
        <span class="label">Date:</span> {{weddingDate}}
      </div>
      <div class="detail-row">
        <span class="label">Time:</span> {{weddingTime}}
      </div>
      <div class="detail-row">
        <span class="label">Venue:</span> {{venueName}}
      </div>
      <div class="detail-row">
        <span class="label">Address:</span> {{venueAddress}}
      </div>
    </div>
    ...
    <div class="footer">Created with Invitasyon</div>
  </div>
</body>
</html>`;
...
export default function NewTemplatePage() {
  ...
  const renderPreview = () => {
    ...
    // Clean any remaining {{#if ...}} {{/if}} tags
  ...
  return (
    <div className="p-6 max-w-4xl">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-charcoal-500 text-sm">
            Design a wedding invitation template with HTML and metadata variables.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="e.g. Romantic Blush"
                  />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="e.g. Romantic, Floral, Soft"
                />
              </div>
          ...
          <Card>
            <CardHeader>
              ...
              <p className="text-xs text-charcoal-400 mt-1">
                Use <code className="bg-cream-100 px-1 rounded">{`{{variableName}}`}</code> to insert values. Available: coupleName1, coupleName2, weddingDate, weddingTime, venueName, venueAddress, notes, photoUrl, colorPalette, slug, email + your custom variables.
              </p>
            </CardHeader>
            <CardContent>
              {showPreview ? (
        ...
        {/* Right sidebar: Metadata variables */}
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <p className="text-xs text-charcoal-400 mt-1">
                Define custom variables beyond the built-in ones. Use {`{{key}}`} in your HTML.
              </p>
            </CardHeader>
            <CardContent className="space-y-3">
              {/* Built-in variables reference */}
              <div className="bg-cream-50 rounded-xl p-3">
                <p className="text-xs font-medium text-olive-700 mb-2">Built-in variables (auto-available):</p>
              ...
              {varDefs.length === 0 ? (
                <div className="text-center py-6 text-charcoal-400 text-sm">
                  No custom variables yet. Click &quot;Add&quot; to define template variables.
                </div>
              ) : (
                varDefs.map((def, i) => (
